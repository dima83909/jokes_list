module.exports = function(sd) {
	...
	sd.app.get('/Login', signed, function(req, res){
		res.send(sd.derer.renderFile(__dirname+'/Login.html', {
			title: sd.config.name+' | Login',
	...
	sd.app.get('/Sign', signed, function(req, res){
		res.send(sd.derer.renderFile(__dirname+'/Sign.html', {
			title: sd.config.name+' | Sign up',
	...
	sd.app.get('/Reset', signed, function(req, res){
		res.send(sd.derer.renderFile(__dirname+'/Reset.html', {
			title: sd.config.name+' | Reset',
	...
	sd.app.get('/Recover', signed, function(req, res){
		res.send(sd.derer.renderFile(__dirname+'/Recover.html', {
			title: sd.config.name+' | Recover',
